...
class MainScreen(MDScreen):
    ...
    def __init__(self, **kwargs):
        ...
        self.add_widget(self.text_field0)
        self.add_widget(self.text_passrd)
        self.add_widget(self.text_login)
        self.add_widget(self.text_server) 
        self.add_widget(self.text_ip)        
        self.add_widget(self.text_port) 
    ...
    def on_confirm(self, instance):
        ...
        def on_error(req, error):
            self.text_field0.hint_text = "Сервер не отвечает"
            self.text_passrd.text = ''
            self.text_login.text = ''
            MainScreen.access = req._result
